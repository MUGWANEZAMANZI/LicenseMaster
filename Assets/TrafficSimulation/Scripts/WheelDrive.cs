...
namespace TrafficSimulation{
    ...
    public class WheelDrive : MonoBehaviour
    {
        ...
        [Tooltip("Drag the wheel shape here.")] //Need to remove this and find a workaround way so the vehicle could move point to point
        ...
        void OnEnable(){
            ...
            for (int i = 0; i < wheels.Length; ++i) 
            {
                ...
                // Need to remove this and find a workaround way so the vehicle could move point to point
                ...
                // Need to remove above and find a workaround way so the vehicle could move point to point
